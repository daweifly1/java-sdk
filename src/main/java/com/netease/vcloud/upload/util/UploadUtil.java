...
public class UploadUtil {
    ...
    private GetVideoDetailModule getVideoDetailModule;
    ...
    public UploadUtil(GetVideoDetailModule getVideoDetailModule) {
        this.getVideoDetailModule = getVideoDetailModule;
    }
...
//		logger.info("[UploadUtil] : json stringBody" + stringBody);
    ...
    public GetVideoDetailParam getVideoDetail() throws IOException, VcloudException {
			/* 接口 */
        /** 获取单个视频的URL 默认值  https://vcloud.163.com/app/vod/video/get */
        String url = Config.getSingleVideoURL();
		/* 设置请求的参数 */
        StringEntity params = new StringEntity(JSON.toJSONString(getVideoDetailModule), "UTF-8");

        //logger.info(JSON.toJSONString(queryVideoIDorWatermarkIDModule));
		/* 得到Json数据 */
        GetVideoDetailParam getVideoDetailParam = (GetVideoDetailParam) jsonParamObjectBuilder(url, params, GetVideoDetailParam.class);
