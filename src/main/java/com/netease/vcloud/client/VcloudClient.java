...
import com.netease.vcloud.upload.service.impl.GetVideoDetailServiceImpl;
...
public class VcloudClient {
    ...
    public GetVideoDetailParam getVideoDetail(Long vid) throws IOException, VcloudException {
        GetVideoDetailService getVideoDetailService = new GetVideoDetailServiceImpl();
        return getVideoDetailService.getVideoDetail(vid);
    }
